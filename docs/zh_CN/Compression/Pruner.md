# [此处](https://github.com/microsoft/nni/tree/v1.9/examples/model_compress/lottery_torch_mnist_fc.py)为实现代码。
...
此外，我们还为 L1FilterPruner 提供了依赖感知模式。 参考 [dependency-aware mode](./DependencyAware.md) 获取依赖感知模式的更多细节。
